...
(() => {
  ...
  const stylesheet =
    ...
    // touch-action must stay permissive in the normal (non-reframe) state, or a
    // touch that starts on a photo swallows the page scroll. Pan gestures are
    // only needed while reframing, so lock it there and nowhere else.
